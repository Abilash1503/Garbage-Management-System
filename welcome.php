    ...
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        if($service_available=='1'){
            ...
            <a class='btn btn-warning' href='disabled_user_application.php?service_id=$garbage_id'>disabled service</a>";
                                ...
                                echo "
                                <a class='btn btn-primary' href='view_application_details.php?garbage_id=$garbage_id'>view_service</a>";
                            }
                            echo"
                    ...
                    $service_available=$row['service_available'];      
                        ...
                        <div class='card' style='box-shadow: 0 0 0px rgb(0 0 0) !important;'>
                            <div class='card-body'>
                                ...
                                if($service_available=='not available'){
                                    echo"  
                                    <a class='btn btn-warning' href='disabled_user_application.php?garbage_id=$garbage_id'>disabled service</a>";
                                }
                                                    else{
                                                        echo "
                                                        <a class='btn btn-primary' href='view_application_details.php?garbage_id=$garbage_id'>view_service</a>";
