...
$showError=false;
 ...
 $select_display= "select login_username,email,Mno,fname,address,state,city,zip from profile where login_username='$login_username'" ;
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
   ...
   //$email=$_POST['email'];
   $select= "select * from profile where login_username='$login_username'";
   ...
   if($res === $login_username)
   {
	  ...
	  $update = "update profile set address='$address',state='$state',city='$city',zip='$zip' where login_username='$login_username'";
						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="<?php echo $fname?>" name="fname"id="fname" disabled>
								</div>
