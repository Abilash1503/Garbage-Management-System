...
<?php include 'nav.php';?>
		...
		<div class="main-body">
			...
			<div class="row">
					...
					<!--card form-->
							...
							<p style="color:black;"><b>past Requests</b></p>
					</div>
 ...
 $current_date = date("Y-m-d", time());
    ...
    $select_display2="select  * from application_request where  login_username='$login_username' and application_request.permission='1' and application_request.service_date<'$current_date' ";
    ...
    while($row=mysqli_fetch_assoc($sql3)){
        ...
        echo "
                        ...
                        <div class='card' style='box-shadow: 0 0 0px rgb(0 0 0) !important;'>
                            ...
                            <td>completed</td>
                                ...
                                <div><br><br></div>
                                <a class='btn btn-success' href='raise_complaint.php?application_request_id=$application_request_id'target='_blank'>raise complaint</a>
        ...
        <div class="row">
                ...
                <!--card form-->
                        ...
                        <p style="color:black;"><b>present request</b></p>
                </div>
        ...
        <!-- okie -->
			...
			<div class="row">
                ...
                <!--card form-->
                        ...
                        <p style="color:black;"><b> upcoming  Requests</b></p>
                </div>
