						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control"   name="driver_unique_id" id="driver_unique_id" placeholder="driver unique id"   required>
								</div>
							</div>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select  * from driver where driver_unique_id='$driver_unique_id' " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>
        <a class='btn btn-primary' href='view_driver.php?driver_unique_id=$driver_unique_id'>View driver Details</a>
...
";
    ...
    $select_display="select  * from driver" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
