...
$showError=false;
 ...
 $garbage_type=$_GET['garbage_type'];
...
<!--fetch sechedule-->
        ...
        <div class="row">
            ...
            <?php
               ...
               if(isset($_POST['monday'])) {
                            $select_display="select * from slot_timetable where day='monday' and garbage_type='$garbage_type'" ;
                                           ...
                                           while($row=mysqli_fetch_assoc($sql1)){
                                               $start_time=$row['start_time'];
                                                   ...
                                                   <div class='card text-center' style='box-shadow: 0 0 0px rgb(0 0 0) !important; background-color: #ffd9fa; '>
                                                                   ...
                                                                   <p class='text-dark mb-1' style='border-radius: 4%;'><small>$vehicle_unique_id</small></p>
                                                                   <p class='text-dark mb-1 ' style='border-radius: 4%;'><small>$garbage_type</small></p>
                                                          
                                                                   <div class='text-center'>
                                                                   
                                                                   <a class='btn btn-primary' href='edit_slot_time.php?slot_id=$slot_id' style='width:100px'>edit</a>
                                                                   <br>

                                                                   <a class='btn btn-danger mt-1' href='delete_slot_time.php?slot_id=$slot_id' style='width:100px'>delete</a>
                                                                   </div>
                                                                   <br>
                                                                   </div>
            ...
            $select_display="select * from slot_timetable where day='tuesday' and garbage_type='$garbage_type'" ;
                           $sql1 = mysqli_query($conn,$select_display);
                           while($row=mysqli_fetch_assoc($sql1)){
                               $start_time=$row['start_time'];
                                   $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where day='wednesday' and garbage_type='$garbage_type'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where garbage_type='$garbage_type' and day='thursday'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where garbage_type='$garbage_type' and day='friday'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where garbage_type='$garbage_type' and day='saturday'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where garbage_type='$garbage_type' and day='sunday'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
    ...
    $select_display="select * from slot_timetable where garbage_type='$garbage_type' and day='$mydate[weekday]'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                       $start_time=$row['start_time'];
                           $end_time=$row['end_time'];
