...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $vehicle_unique_id=$_POST["vehicle_unique_id"];
        // $exists = false; 
            ...
            $sql = "INSERT INTO `schedule`(`route_name`, `stop`,`vehicle_unique_id`) values('$route_name', '$stop', '$vehicle_unique_id')";
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control"   name="stop" id="stop"  placeholder="enter stoppage"   required>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									<input type="submit" class="btn btn-primary px-4" value="add stop">
								</div>
							</div>
						</div>
						</form>
