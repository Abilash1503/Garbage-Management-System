...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "Select * from admin where  admin_username='$admin_username' and verification_status=1 ";
    ...
    if ($num == 1){
        while($row=mysqli_fetch_assoc($result)){
            if (password_verify($password, $row['password'])){ 
                ...
                $login = true;
                header("location: add_garbage.php");
		...
		$sql2 = "Select * from admin where  admin_username='$admin_username' AND verification_status=0";
...
-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
	...
	<div class="container ">
		<div class="main-body">
			<h1 style="margin-left:90px">GARBAGE MANAGEMENT SYSTEM</h1>
			<div class="row">
				...
				<div class="col-lg-9 mt-5 pl-5">
					<!--card form-->
					<div class="card"  style="width:95%; background-color:#a8f28a;box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );backdrop-filter: blur( 4px );
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="admin" name="admin_username" id="admin_username">
								</div>
							</div>
