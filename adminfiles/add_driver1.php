	...
	$password=$_POST["password"];
     $hash = password_hash($password,PASSWORD_DEFAULT);
        ...
        // $exists = false; 
            ...
            $sql = "INSERT INTO driver(`driver_unique_id`, `driver_name`, `email`, `Mno`, `age`,`vehicle_unique_id`,`date_of_joining`,`password`) values('$driver_unique_id', '$driver_name', '$email', '$Mno','$age','$vehicle_unique_id','$date_of_joining','$hash')";
            
            $result = mysqli_query($conn, $sql);
            if($result){

				$sql_profile ="INSERT INTO driver_admin (`driver_unique_id`,`driver_name`, `email`,`vehicle_unique_id`,`password`) SELECT `driver_unique_id`,`driver_name`, `email`,`vehicle_unique_id`,`password` from driver WHERE NOT EXISTS (SELECT `driver_unique_id` FROM driver_admin WHERE driver_admin.driver_unique_id= driver.driver_unique_id) LIMIT 1";
				$result1 = mysqli_query($conn, $sql_profile);
                ...
                $to = "$email";
                $sub = "account credentials Verification ";
                $msg="
                thank you for signing up on our website.
                please click on the verification link below to verify your email password is:$password";
			...
			<div class="row">
				...
				<div class="col-lg-9 mt-5 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="add_driver1.php" method="POST">
							<div class="row mb-3">
								<div class="col-sm-3">
