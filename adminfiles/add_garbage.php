...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$timestamp = date("Y-m-d H:i:s");
        ...
        // $exists = false; 
            ...
            $sql = "INSERT INTO `garbage_category`(`garbage_type`,`description`,`admin_username`,`create_datetime`) VALUES ('$garbage_type', '$description','$admin_username','$timestamp')";
			...
			<div class="row">
				...
				<div class="col-lg-9 mt-5 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="add_garbage.php" method="POST">
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">garbage type</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="enter garbage type" name="garbage_type" id="garbage_type">
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
