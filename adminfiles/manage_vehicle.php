			...
			<div class="row">
                <div class="col-lg-9 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="manage_vehicle.php" method="POST">
							
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Search Vehicle</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control"  name="vehicle_unique_id" id="vehicle_unique_id" required>
								</div>
							</div>					
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select  * from vehicle where vehicle_unique_id='$vehicle_unique_id' order by color" ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        if($vehicle_available=='enabled'){
            echo" <a class='btn btn-success' href='vehicle_available.php?vehicle_unique_id=$vehicle_unique_id '>enabled</a>
         ";}
        
         else{
             echo" <a class='btn btn-danger' href='vehicle_not_available.php?vehicle_unique_id=$vehicle_unique_id '>disabled</a>
             ";}
...
";
        ...
        $select_display="select  * from vehicle order by color ; " ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
                    ...
                    $color=$row['color'];
                        ...
                        <div class='card' style='box-shadow: 0 0 0px rgb(0 0 0) !important;'>
                            <div class='card-body'>
                                <div class='d-flex flex-column align-items-center text-center'>
                                    <img src='truck.png' alt='Admin' class='rounded-circle p-1 ' height='150' width='200' style='background:$color'>
                                    <div class='mt-3'>
                                    <table>
                                    <tr>
                                    <th>vehicle unique Id:</th> 
