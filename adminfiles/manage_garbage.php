			...
			<div class="row">
                <div class="col-lg-9 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="manage_garbage.php" method="POST">
							
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Search Garbage</h6>
								</div>
								<div class="col-sm-9 text-secondary">
								<input type="text" class="form-control"  name="garbage_type" id="garbage_type" required>
								</div>
							</div>					
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select  * from garbage_category where garbage_type='$garbage_type' " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>";
        echo" <a class='btn btn-primary' href='view_garbage.php?garbage_type=$garbage_type '>view details</a>
        ";
        
        if($service_available=='available'){
            echo" <a class='btn btn-success' href='garbage_available.php?garbage_id=$garbage_id '>Available</a>
         ";}
        
         else{
             echo" <a class='btn btn-danger' href='garbage_not_available.php?garbage_id=$garbage_id '>Not Available</a>
             ";}
...
";
        ...
        $select_display="select  * from garbage_category order by service_available asc; " ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
