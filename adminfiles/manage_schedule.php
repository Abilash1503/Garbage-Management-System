						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control"   name="route_name" id="route_name" placeholder="route_name"   required>
								</div>
							</div>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select  distinct route_name from schedule where route_name='$route_name'" ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>
        <a class='btn btn-primary' href='view_schedule.php?route_name=$route_name'>View schedule Details</a>
...
";
    ...
    $select_display="select  distinct route_name from schedule";
    $sql1 = mysqli_query($conn,$select_display);
    while($row=mysqli_fetch_assoc($sql1)){
                        ...
                        <div class='card' style='box-shadow: 0 0 0px rgb(0 0 0) !important;'>
                            <div class='card-body'>
                                <div class='d-flex flex-column align-items-center text-center'>
                                    ...
                                    <div><br><br></div>
                                    <a class='btn btn-primary' href='view_schedule.php?route_name=$route_name'>View  full route </a>
